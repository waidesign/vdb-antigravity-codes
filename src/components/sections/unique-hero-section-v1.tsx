...
export function UniqueHeroSectionV1({ layout, columns, className, theme, isDark }: UniqueHeroSectionProps) {
    ...
    return (
        <section className={cn(
            ...
            <div className="max-w-7xl mx-auto">
                <div className={cn("grid gap-8 lg:gap-16 items-center", layoutMap[layout] || layoutMap['one-column'])}>
...
export default UniqueHeroSectionV1;
