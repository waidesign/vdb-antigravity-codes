...
export function HowItWorksSectionV2({ layout, columns, className, theme, isDark }: HowItWorksSectionProps) {
    ...
    return (
        <section className={cn(
            ...
            {/* The primary encapsulating dark gradient box */}
            <div 
                className="max-w-6xl mx-auto rounded-[2rem] p-10 lg:py-20 lg:px-16 shadow-2xl relative overflow-hidden border" 
                style={{ background: "#171717", borderColor: "#6F6F6F" }}
            >
                <div className={cn("relative z-10 grid gap-12 items-center text-center", layoutMap[layout] || layoutMap['one-column'])}>
