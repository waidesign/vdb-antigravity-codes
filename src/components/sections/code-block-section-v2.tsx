...
export type CodeBlockSectionV2Props = {
...
export function CodeBlockSectionV2({ layout, columns, heading, description, className, theme, isDark }: CodeBlockSectionV2Props) {
    ...
    return (
        <section className={cn(
            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-12">
                    ...
                    <div className="flex flex-col gap-4 max-w-3xl">
                        ...
                        {description && (
                            <p className={cn(
                                ...
                                effectiveIsDark ? "text-[#A9ADB5]" : "text-neutral-600"
                            )}>
                                {description}
                            </p>
                        )}
                ...
                <div className={cn("grid gap-8 lg:gap-16 items-start", layoutMap[layout] || layoutMap['two-column'])}>
...
export default CodeBlockSectionV2;
